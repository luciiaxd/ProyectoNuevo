// Archivo: tarjetas.data.commented.ts
// Datos de ejemplo (arreglo) que representan los productos (tarjetas). Estos datos
// son importados por el servicio TarjetasService para mostrarlos en la aplicación.
